...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with VI CONNECT NETWORKSERVICES LTD. Email viconnectnets@gmail.com or call 0788825646." },
      { property: "og:title", content: "Contact VI CONNECT NETWORKSERVICES LTD" },
      { property: "og:description", content: "Reach us by email, phone, or the contact form on our website." },
    ],
  }),
...
const info = [
  { Icon: Mail, title: "Email", value: "viconnectnets@gmail.com", href: "mailto:viconnectnets@gmail.com" },
    ...
    <div>
      <section className="container-page pt-14 pb-8 max-w-3xl">
        ...
        <p className="text-muted-foreground mt-4 text-lg">
          Have a question, need a quote, or want to schedule an installation? We'd love to hear
          from you.
        </p>
      </section>
      ...
      <section className="container-page pb-20 grid gap-8 lg:grid-cols-2">
        <Card>
          <CardContent className="p-6 md:p-8">
            ...
            <p className="text-muted-foreground mt-1 text-sm">We usually respond within 24 hours.</p>
            <form
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                <li className="flex justify-between"><span className="text-muted-foreground">Monday – Friday</span><span>8:00 – 18:00</span></li>
                <li className="flex justify-between"><span className="text-muted-foreground">Saturday</span><span>9:00 – 16:00</span></li>
